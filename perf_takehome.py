            ...
            def start_block():
                ...
                if next_block == 0:
                    active.append({
                        ...
                        "stage": 0,
                        "gather": 0,
                        "direct_idx_addr": self.scratch["inp_indices_p"],  # Use directly
                        "direct_val_addr": self.scratch["inp_values_p"],   # Use directly
                    })
                else:
                    active.append({
                        "block": next_block,
            ...
            while active or next_block < vector_blocks:
                ...
                for block in active:
                    ...
                    if block["phase"] == "store_both" and block["block"] not in scheduled_this_cycle:
                        buf = block["buf"]
                        # Use direct address for block 0, computed address otherwise
